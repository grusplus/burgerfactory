	...
	<div id="primary" class="content-area content">
		<main id="main" class="site-main" role="main">
            <div class="row banner-row">
                <div class="col-12">
                    <div style="margin-bottom:24px;"><img alt="grapefruit mental health app logo" src="https://haveagrapefruit.s3.amazonaws.com/img/logo-shadow.png" width="64"></div>
                    <h1 class="lede" style="margin:0 auto 40px;max-width:500px;">Track your mental health without being tracked.</h1>
                    <div><img style="width:660px;position:relative;left:24px;" alt="grapefruit mental health app banner" src="https://haveagrapefruit.s3.amazonaws.com/img/banner.jpg"></div>
